...
@WebServlet("/AdicionarIntegrante")
public class AdicionarIntegrante extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(foto == null)
				dao.inserirIntegrante(i);
			else {
				dao.inserirIntegrante(i, foto, request.getRealPath("/"));
			}
		...
		*/
		request.setAttribute("msgSucesso", "Integrante adicionado com sucesso!");
